                    ...
                    <div className="site-footer__nav py-5 py-md-6">
                        <div className="container">
                            ...
                            >
                                ...
                                {hasSecondaryNav && !_.isEmpty(secondaryNavLinks) && this.renderNav(secondaryNavLinks, secondaryNavTitle, 'secondary_nav_links')}
                                {hasTertiaryNav && !_.isEmpty(tertiaryNavLinks) && this.renderNav(tertiaryNavLinks, tertiaryNavTitle, 'tertiary_nav_links')}
                            </div>
                        </div>
                    </div>
                )}
